...
import {
    ...
    id = "arn:aws:iam::188245254368:oidc-provider/app.terraform.io"
}
...
import {
    to = aws_iam_role_policy_attachment.tfc_policy_attachment
    id = "tfc-role/arn:aws:iam::aws:policy/AdministratorAccess"
}
